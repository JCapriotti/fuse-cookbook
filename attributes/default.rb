...
default['fuse']['base']['url'] = 'http://192.168.0.1'
default['fuse']['url'] = "#{node['fuse']['base']['url']}/#{node['fuse']['filename']}.zip"
default['fuse']['dir'] = '/opt'
default['fuse']['extraction_folder'] = "#{node['fuse']['filename']}"
default['fuse']['home'] = "#{node['fuse']['dir']}/#{node['fuse']['extraction_folder']}"
...
default['fuse']['m2_dir'] = "/home/#{node['fuse']['os']['user']}/.m2"
